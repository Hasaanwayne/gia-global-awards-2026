...
const FAQS = [
    ...
    { q: "How does the entry process work?", a: "The awards use a two-stage process. Stage one is an open nominations period, free, quick, and under five minutes to complete. After nominations close in August, we select up to 30 longlisted nominees per category. Longlisted nominees are notified within one week of nominations closing, and invited to complete a full stage two submission by the end of August. Stage two submissions go to our independent judging panel, who rank their top ten. Ten finalists per category are announced in September. Winners are revealed at the awards evening in November." },
    ...
    { q: "I'm on the Global Talent Visa but I'm not a founder. Can I enter?", a: "Yes. The Global Talent Award category is specifically for Global Talent Visa holders, Exceptional Promise or Exceptional Talent endorsement, and is open to founders, employees, researchers, artists, designers and independent experts alike. If you hold the Global Talent Visa and have also founded a business, you are equally eligible to enter Categories 01, 02, 04, 05, 06, 07, 08 and 09 where you meet the criteria for those categories." },
    ...
    { q: "How do I buy a ticket to the awards evening?", a: "Tickets go on sale in August 2026 via the website. Join the waitlist on globalinnovatorawards.com now for priority access and an early bird discount. Finalists receive a unique discounted ticket code communicated directly to them by the events team after the shortlist announcement. All ticket sales are final. Refunds are available only if the event is cancelled or rescheduled with no alternative date offered." },
