...
const FAQS = [
    ...
    { q: "How does the entry process work?", a: "The awards use a two-stage process. Stage one is an open nominations period, free, quick, and under five minutes to complete. After nominations close in August, we select up to 30 longlisted nominees per category. Longlisted nominees are notified within one week of nominations closing, and invited to complete a full stage two submission by the end of August. Stage two submissions go to our independent judging panel, who rank their top ten. Ten finalists per category are announced in September. Winners are revealed at the awards evening in October." },
